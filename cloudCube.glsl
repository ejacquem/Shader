...
const vec4 spColor = vec4(0.49, 0.88, 0.41, 1.0);
const int steps = 200;
...
void main(){
    ...
    float a = (sin(u_time) + 1.0) * 2.0 * 50. + 100.0;
    gl_FragColor = mix(bgColor, spColor, float(insideNbr) / a);
}